...
export JOB_DIR="/lustre/fsw/coreai_mlperf_training/users/michalm/references/llama31_8b"
# Image / container path, either local cache file or remote URL
export IMAGE="gitlab-master.nvidia.com/dl/mlperf/training_references:llama31_8b_2504"
...
export PREPROCESSED_PATH="/lustre/share/coreai_mlperf_training/data/c4/8b"
export MERGED_C4_PATH="/lustre/share/coreai_mlperf_training/data/c4/8b"
# Dataset: Numpy index working directory, contains shuffled dataset
# This path must be able to hold >400GB data
export TMP_NPY_INDEX="/lustre/fsw/coreai_mlperf_training/users/michalm/references/llama31_8b/npy_index"
# Dataset: Tokenizer path
# This corresponds to the TOKENIZER_PATH in README section 3's tokenizer download part
export TOKENIZER_PATH="/lustre/share/coreai_mlperf_training/data/c4/8b/tokenizer"
...
export MODEL_CKPT="/lustre/fsw/coreai_mlperf_training/users/michalm/references/llama31_8b/checkpoints"
...
export CONT_IMAGE_URL="gitlab-master.nvidia.com/dl/mlperf/training_references:llama31_8b_2504"
